...
- **Email**: SMTP via [PHPMailer](https://github.com/PHPMailer/PHPMailer) (Dreamhost `nomadtri.com`)
...
```bash
# 1. Clone the repo
git clone <repo-url> nomadtri-api
cd nomadtri-api
...
- **nomadtri-api** — PHP 8.3 + Apache on port `8080`
- **nomadtri-db** — MySQL 8.0 on port `3306`
...
APP_DEBUG=true
DB_HOST=db
DB_NAME=nomadtri_api
DB_USER=nomadtri
DB_PASS=nomadtri_secret
...
- **SMTP**: Sends via Dreamhost's `mail.nomadtri.com` (port 465, SSL)
...
APP_ENV=production
APP_DEBUG=false
APP_URL=https://api.nomadtri.com

DB_HOST=mysql.nomadtri.com
...
CORS_ALLOWED_ORIGINS=https://nomadtri.com

SMTP_HOST=mail.nomadtri.com
SMTP_PORT=465
SMTP_ENCRYPTION=ssl
SMTP_USER=noreply@nomadtri.com
SMTP_PASS=your_email_password
SMTP_FROM_EMAIL=noreply@nomadtri.com
SMTP_FROM_NAME="NomadTri API"
```
